...
Write-Host "Setting Certificate Renewal Threshold for Immediate Testing" -ForegroundColor Cyan
...
try 
{
    ...
    Write-Host "0. Loading Azure PowerShell modules..." -ForegroundColor Yellow
    try {
        Import-Module Az.Automation -Force
        Write-Host "   Azure Automation module loaded successfully" -ForegroundColor Green
    } catch {
        Write-Host "   Installing Azure Automation module..." -ForegroundColor Yellow
        Install-Module Az.Automation -Force -AllowClobber
        Import-Module Az.Automation -Force
        Write-Host "   Azure Automation module installed and loaded" -ForegroundColor Green
    }
